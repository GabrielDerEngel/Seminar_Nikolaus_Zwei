...
namespace VariadicTemplatesIntro_01 {
    ...
    //void printer(T n, T2 m)   // NICHT Variadisch
    //{
    //    std::cout << n << "-";
    //    std::cout << m << "-";
    //}

    //void printer(int n)   // NICHT Variadisch, NON template
    //{
    //    std::cout << n << " ";
    //}

    // MERKER: printer für 2 Werte nicht variadisch

    template <typename T>
    void printer(T n)   // NICHT Variadisch
    {
        std::cout << n << " ";
    }

    // n Werte => n-1 Werten  pack  Pack
    template <typename T1, typename ... TREST>
    void printer(T1 n, TREST ... rest)
    {
        std::cout << n << " ";
        //printer<T1>(n);
        //printer(n);
    ...
    //    if constexpr ( sizeof ... (rest) > 0 )   // Ab C++ 17 Wunsch; Nur eine Funktion
    //    {
    //        printer<TREST ...>(rest ...);
    //    }
    //}
...
namespace VariadicTemplatesIntro_04 {
    ...
    public:
        ...
        explicit Unknown(int n) : m_var1{ n }, m_var2{ -1 }, m_var3{ -1 } {
    ...
    // Ähnlichkeiten (!!!) zu einer Fabrik erwünscht
    template<typename T, typename ... TARGS>
    T make_an_object(const TARGS&... args)
    {
        return T{ args... };  // Objekt vom Typ T AM STACK
                              // angelegt und zurückgeliefert
    }

    template<typename T, typename ... TARGS>
    T make_an_object_2(const T& dummy, const TARGS&... args)
    {
        return 2 * dummy;
        //return T{ args... };  // Objekt vom Typ T AM STACK
                              // angelegt und zurückgeliefert
    ...
    void test_make_an_object()
    {
        ...
        //Unknown u3 = make_an_object_2(123123, 10, 11);
...
namespace VariadicTemplatesIntro_05 {
    ...
    template<typename T, typename... Args>
    std::unique_ptr<T> my_make_unique(const Args&... args)
    {
    ...
    void test_my_make_unique()
    {
        ...
        std::unique_ptr<Unknown> up3 =
            my_make_unique<Unknown, int, int>(10, 11);
