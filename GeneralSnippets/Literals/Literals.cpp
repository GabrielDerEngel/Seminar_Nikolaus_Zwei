...
namespace Literals_Color_Runtime {
    ...
    // C++ Festlegung: 
    // Kein int, short, long ...... SONDERN: Nur der größtmögliche Datentyp
    // 2 Varianten: Ganzzahlig und Gleitpunktzahl (long double)
    ...
    void test_02_with_errors() {
        ...
        // int einWert = 11111111111111111111111111111111111111;
...
namespace Literals_Color_CompileTime {
    ...
    // C++  17  // C++ 14 NICHT Möglich: kein for, while, do-while in constexpr
    ...
    constexpr Color operator"" _rgb(const char* literal, size_t) {
        ...
        // ABER (C++ 17 )  KEIN std::string :-(((((  
        // Wo sind wir jetzt: In den guten alten Tagen von C :)
    ...
    void test_03_with_errors() {
        ...
        // illegal hexadecimal digit
      // constexpr Color col2 = "0x00GG00"_rgb;   // Add - On // "eher spielerisch zu sehen"
    }
}
