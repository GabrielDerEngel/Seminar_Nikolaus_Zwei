...
namespace WeakPointer {
    ...
    void test_01() {
        ...
        // wäre auch durch einen Unterprogramm- Aufruf gegangen ...
        {
    ...
    class ParentNode {
    private:
        std::weak_ptr<const RightNode> m_rightNode;   // <== shared or weak ?
        std::weak_ptr<const LeftNode> m_leftNode;     // <== shared or weak ?
